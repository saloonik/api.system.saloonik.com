...
namespace ServiceReference
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName="ServiceReference.checkVatPortType")]
    public interface checkVatPortType
    {
        ...
        System.Threading.Tasks.Task<ServiceReference.checkVatResponse> checkVatAsync(ServiceReference.checkVatRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<ServiceReference.checkVatApproxResponse> checkVatApproxAsync(ServiceReference.checkVatApproxRequest request);
    }
    ...
    public partial class checkVatApproxResponse
    {
        ...
        public checkVatApproxResponse(
                    ...
                    string traderCity, 
                    ServiceReference.matchCode traderNameMatch, 
                    ServiceReference.matchCode traderCompanyTypeMatch, 
                    ServiceReference.matchCode traderStreetMatch, 
                    ServiceReference.matchCode traderPostcodeMatch, 
                    ServiceReference.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public interface checkVatPortTypeChannel : ServiceReference.checkVatPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "8.0.0")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<ServiceReference.checkVatPortType>, ServiceReference.checkVatPortType
    {
        ...
        public System.Threading.Tasks.Task<ServiceReference.checkVatResponse> checkVatAsync(ServiceReference.checkVatRequest request)
        {
            return base.Channel.checkVatAsync(request);
        }
        
        public System.Threading.Tasks.Task<ServiceReference.checkVatApproxResponse> checkVatApproxAsync(ServiceReference.checkVatApproxRequest request)
        {
